...
INSERT INTO Artikal (Naziv, Opis, Kategorija, Aktivan) VALUES
    ...
    (N'Ugao (manji)', NULL, N'Namještaj', 1),
    (N'Ugao (veliki)', NULL, N'Namještaj', 1),
...
FROM (VALUES
    ...
    (N'Ugao (manji)', N'Dubinsko čišćenje', 60.00, NULL),
    (N'Ugao (veliki)', N'Dubinsko čišćenje', 80.00, NULL),
